...
import Dropdown from '@/Components/Frontend/Dropdown.vue';
import SearchModal from '@/Components/Frontend/SearchModal.vue';
...
<template>
    ...
    >
        ...
        >
            <div
                class="p-4 flex flex-row items-center justify-between space-x-2"
            >
                <a
                    href="/"
