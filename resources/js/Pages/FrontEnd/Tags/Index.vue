        ...
        <main class="max-w-6xl mx-auto mt-6 min-h-screen">
            <section class="bg-gray-200 dark:bg-gray-900 dark:text-white mt-4 p-2 rounded">
                ...
                <div class=" grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 rounded">
                    <MovieCard v-for="genre in movies.data" :key="genre.slug">
                        <template #image>
                            <Link :href="route('genres.show', genre.slug)">
                            <div class="aspect-w-2 aspect-h-3">
                                <img class="object-cover"
                                    :src="`https://www.themoviedb.org/t/p/w220_and_h330_face/${genre.poster_path}`">
                            </div>
                            <div
                        ...
                        <Link :href="route('casts.show', genre.slug)">
