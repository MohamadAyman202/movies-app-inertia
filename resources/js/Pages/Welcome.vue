        ...
        <main class="max-w-6xl mx-auto mt-6 min-h-screen">
            <section class="bg-gray-200 dark:bg-gray-900 dark:text-white mt-4 p-2 rounded">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 rounded">
                    <MovieCard v-for="movie in movies" :key="movie.slug">
                        <template #image>
                            ...
                            <div
                                ...
                                <div v-for="genre in movie.genres" :key="genre.slug">
                                    {{ genre.title }}
                                </div>
                            </div>
                            </Link>
            ...
            <section class="bg-gray-200 dark:bg-gray-900 dark:text-white mt-4 p-2 rounded">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 rounded">
                    <MovieCard v-for="episode in episodes" :key="episode.slug">
                        <template #image>
            ...
            <section class="bg-gray-200 dark:bg-gray-900 dark:text-white mt-4 p-2 rounded">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 rounded">
                    <MovieCard v-for="tvShow in tvShows" :key="tvShow.slug">
                        <template #image>
